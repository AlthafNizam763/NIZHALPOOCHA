  ...
  return (
    <html lang="en" className="h-full">
      <head>
        ...
        <link
          rel="stylesheet"
          href="https://fonts.googleapis.com/css2?family=Baloo+Chettan+2:wght@500;700&family=Manrope:wght@400;500;600;700&family=Noto+Sans+Malayalam:wght@400;600&display=swap"
        />
      </head>
