    ...
    <div className="relative select-none text-center" role="img" aria-label="Nizhalpoocha · നിഴൽപ്പൂച്ച">
      <div className="relative inline-block">
        ...
        <svg viewBox="0 0 60 40" className={`absolute left-0 ${compact ? '-top-3 w-10' : '-top-5 w-14 sm:-top-6 sm:w-16'}`} aria-hidden>
          <path d="M6 38 L8 6 L20 18 Q30 14 40 18 L52 6 L54 38 Z" fill="#070a09" stroke="#e9b04f" strokeWidth="1.5" />
          <ellipse cx="22" cy="28" rx="4.5" ry="3" fill="#e9b04f" className="animate-[blink_5s_infinite]" />
          <ellipse cx="38" cy="28" rx="4.5" ry="3" fill="#e9b04f" className="animate-[blink_5s_infinite]" />
      ...
      <div
        ...
        style={{ textShadow: '1.5px 1.5px 0 #1b0f06, -1.5px -1.5px 0 #1b0f06, 1.5px -1.5px 0 #1b0f06, -1.5px 1.5px 0 #1b0f06, 0 1.5px 0 #1b0f06, 0 -1.5px 0 #1b0f06, 1.5px 0 0 #1b0f06, -1.5px 0 0 #1b0f06, 0 3px 0 #1b0f06, 0 0 18px rgba(233,176,79,.35)' }}
      >
        നിഴൽപ്പൂച്ച
      </div>
    </div>
